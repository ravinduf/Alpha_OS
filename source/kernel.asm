...
; ==================================================================
	...
	%DEFINE ALPHA_OS_VER '1.0.0'	; OS version number
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as RAVINDU_OS and its programs
...
option_screen:
	...
	mov cx, 10010000b		; Colour: white text on light blue
	...
	jne near hardware_info_display 	;calls hardware_info_display
	

	call bye		 ;Otherwise shutdown

	; Data for the above code...

	os_init_msg		db 'Welcome to Alpha_OS', 0
	os_version_msg		db 'Alpha_OS ', ALPHA_OS_VER, 0

	dialog_string_1		db 'Welcome to Alpha_OS!', 0
	dialog_string_2		db 'Please select Info to get hardware ', 0
	dialog_string_3		db 'information, Cancel to shutdown.', 0
...
bye:  
	...
	cmp ax, 1			; If OK (option 0) chosen, start app selector
	jne near os_shutdown 	;app_selector
	

	call option_screen		 ;Otherwise shutdown
		
	.string1	db 'Thank You for using Alpha_OS', 0
	.string2	db 'select Exit for shutdown or', 0
	.string3	db 'Back to go back', 0
	
	
	.title_msg	db 'Bye', 0
	.footer_msg	db 'Alpha_OS ', ALPHA_OS_VER, 0
